...
- Sistemas de sugestões, como por exemplo, caixinha de sugestões e mais avançado sites de endomarketing;
- Benchmarking;
- Stage Gates;
...
- Não há garantia de sucesso (mesmo havendo método);
